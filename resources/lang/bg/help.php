...
return [
    ...
    'sections' => [
        ...
        . '<li><strong>Инсталиране на приложението:</strong> Можете да инсталирате играта като приложение от поддържани браузъри (Chrome/Edge). Използвайте менюто "Инсталиране" или "Add to Home screen" на мобилни устройства, за да създадете shortcut и да стартирате играта в отделен прозорец.</li>'
                . '</ul>'
        ],
        'game_basics' => [
    ...
    . '<ul>'
    . '<li><strong>Раждания:</strong> Всеки ден сървърът изпълнява тик за населението. Нови хора се добавят според вашите <em>къщи</em> и туловете прикрепени към тях. Формулата сумира нивата на къщите и износването (durability) на прикрепените инструменти и добавя толкова хора (ниво 1).</li>'
    ...
    . '<li><strong>Какво се случва при липса на болници:</strong> Ако нямате никакъв болничен капацитет, сървърът все пак ще премахне част от населението поради липса на капацитет, но смъртността е ограничена — в един тик не се премахват повече от 80% от общото население, така че няма да загубите цялото си население наведнъж.</li>'
        ...
        . '<li><strong>Дневни обобщени известия:</strong> След всеки дневен тик за население се създава една обобщена нотификация (в Известия), която показва колко хора са се родили и колко са починали през този тик. Проверявайте Известия за вашето обобщение.</li>'
        . '</ul>'
    ],
        'economy' => [
            ...
            'body' => '<p>Икономиката в играта се базира на генериране, харчене и (при нужда) търговия с ресурси.</p>'
                ...
                . '<ul>'
                . '<li><strong>Кеширани агрегати:</strong> Сървърът вече поддържа кеширани общи стойности за нивата на сградите и туловете (къщи, банки, болници и др.). Тези стойности се използват от пазара и дневните задачи за по-бързи и консистентни изчисления.</li>'
                . '<li><strong>Банки и такси:</strong> Банките намаляват таксата на пазара (taker fee). Ъпгрейдвай банките си, за да намалиш таксите — стойността се пресмята и записва веднага след промяна.</li>'
                . '<li><strong>Поставяне на поръчки:</strong> При поставяне на поръчка системата проверява дали имаш достатъчен баланс да покрие потенциалната такса за поръчката. Ако нямаш нужните средства, поръчката ще бъде отхвърлена, за да се предотврати отрицателен баланс.</li>'
                . '<li><strong>Износване на инструменти и работилници:</strong> Всички инсталирани инструменти сега се износват ежедневно. Без работилници, инструментите издържат само 1 ден (100% износване). Строй работилници за удължаване живота на инструментите — всяко ниво работилница намалява износването с 0.99%, до максимум 100 нива за максимална издръжливост (1% износване, 100 дни живот). Износването на инструментите се случва СЛЕД дневните изчисления на популацията, така че инструментите се отчитат преди да се износят.</li>'
                . '</ul>'
