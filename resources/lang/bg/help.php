...
return [
    ...
    'population' => [
        ...
        . '<li><strong>Болници и смъртност:</strong> Болниците (object_type "hospital") и туловете в тях дават медицинска капацитет. След ражданията сървърът проверява капацитета на болниците срещу текущото население. Ако капацитетът е по-нисък, излишните хора се премахват (умират). Премахването е от най-високите нива надолу (първо старите хора). Ако група хора стигне 0, редът се изтрива от базата.</li>'
        . '<li><strong>Какво се случва при липса на болници:</strong> Ако нямате никакъв болничен капацитет, текущото население се счита за незащитено и ще бъде изцяло премахнато (прилага се смъртност).</li>'
